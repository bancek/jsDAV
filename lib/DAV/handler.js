...
var FormidableStream = require("formidable-stream")
        ...
        if (isStream) {
            ...
            form.onPart = function(part) {
                ...
                if (stream) {
                    ...
                    req.on("end", function() {
                        readDone(null, Util.concatBuffers(buffers));
                    });
                }
            }
                            ...
                            function buildProperties() {
                                ...
                                Async.list(myProperties)
                                    ...
                                    .each(function(prop, cbnextprops) {
                                        ...
                                        else if (prop == "{DAV:}displayname") {
                                            newProperties["200"][prop] = node.getName();
                                            afterGetProperty(prop, myPath, newProperties, cbnextprops);
                                        }
